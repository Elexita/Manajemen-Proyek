...
public class profile_page extends AppCompatActivity {
    ...
    com.ftiuksw.tugasmanpro.DataHelper dbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new com.ftiuksw.tugasmanpro.DataHelper(this);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(com.ftiuksw.tugasmanpro.profile_page.this, com.ftiuksw.tugasmanpro.MainActivity.class);
                startActivity(i);
            }
        });
        ...
        btnHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.profile_page.this, activity_history.class);
                startActivity(i);
            }
        });
