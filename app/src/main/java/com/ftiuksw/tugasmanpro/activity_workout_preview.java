    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.activity_workout_preview.this, com.ftiuksw.tugasmanpro.MainActivity.class);
                startActivity(i);
            }
        });
        ...
        btnHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.activity_workout_preview.this, com.ftiuksw.tugasmanpro.activity_history.class);
                startActivity(i);
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.activity_workout_preview.this, com.ftiuksw.tugasmanpro.activity_workout_time.class);
                startActivity(i);
            }
        });
