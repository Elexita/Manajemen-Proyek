    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.activity_workout_time.this, com.ftiuksw.tugasmanpro.MainActivity.class);
                startActivity(i);
            }
        });
        ...
        btnHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.activity_workout_time.this, com.ftiuksw.tugasmanpro.activity_history.class);
                startActivity(i);
            }
        });
        ...
        String kategori = com.ftiuksw.tugasmanpro.userService.getKategori(com.ftiuksw.tugasmanpro.userService.getBMIIndex(weightOld,heightOld));
        ...
        minutes5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.activity_workout_time.this, activity_workout_preview.class);
