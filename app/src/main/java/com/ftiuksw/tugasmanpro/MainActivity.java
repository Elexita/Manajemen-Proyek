    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.MainActivity.this, profile_page.class);
                startActivity(i);
            }
        });
        ...
        btnWorkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isUserUpdatedProfile()){
                    ...
                    Intent i = new Intent(com.ftiuksw.tugasmanpro.MainActivity.this, activity_workout_time.class);
                    startActivity(i);
                }
        ...
        btnHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.MainActivity.this, activity_history.class);
                startActivity(i);
            }
        });
        ...
        btnTips.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isUserUpdatedProfile()){
                    ...
                    Intent i = new Intent(com.ftiuksw.tugasmanpro.MainActivity.this, TipsActivity.class);
                    startActivity(i);
                }
        ...
        btnResep.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isUserUpdatedProfile()){
                    ...
                    Intent i = new Intent(com.ftiuksw.tugasmanpro.MainActivity.this, activity_resep.class);
                    startActivity(i);
                }
            }
        });
