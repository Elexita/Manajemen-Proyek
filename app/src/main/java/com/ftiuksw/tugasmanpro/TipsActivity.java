    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.TipsActivity.this, com.ftiuksw.tugasmanpro.MainActivity.class);
                startActivity(i);
            }
        });
        ...
        btnHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.TipsActivity.this, activity_history.class);
                startActivity(i);
            }
        });
    }
