...
public class activity_history extends AppCompatActivity {
    ...
    com.ftiuksw.tugasmanpro.DataHelper dbcenter;
    public static com.ftiuksw.tugasmanpro.activity_history activityHistory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(com.ftiuksw.tugasmanpro.activity_history.this, com.ftiuksw.tugasmanpro.MainActivity.class);
                startActivity(i);
            }
        });


        dbcenter = new com.ftiuksw.tugasmanpro.DataHelper(this);
    ...
    public void refreshData(){
        ...
        ListAdapter adapter = new SimpleAdapter(com.ftiuksw.tugasmanpro.activity_history.this, historyList,
